    ...
    if (arguments.length == 0) {
        ...
        c.onload = function() {
            ...
            try {
                ...
                qrcode.result = m;//"Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!";
                if (qrcode.callback != null) {
                    qrcode.callback(qrcode.result)
                }
                return
            ...
            try {
                ...
                console.log(m);
                qrcode.result = m;//"error decoding QR Code"
            }
            if (qrcode.callback != null) {
                qrcode.callback(qrcode.result)
            }
